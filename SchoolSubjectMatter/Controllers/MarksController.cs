...
namespace SchoolSubjectMatter.Controllers
{
    public class MarksController : Controller
    {
        ...
        public MarksController(SchoolSubjectMatterContext context)
        {
            _context = context;
        }
        ...
        {
            var schoolSubjectMatterContext = _context.Mark.Include(m => m.Student).Include(m => m.Subject).Include(m => m.Teacher);
            return View(await schoolSubjectMatterContext.ToListAsync());
        }
